  ...
  return (
    ...
    <div className='mb-10'>
      ...
      <div className='flex justify-center items-center'>
        ...
        <CFormFloating>
            <CFormInput type="text"  style={{ width: '280px',height:'60px' }} ref={name} id="floatingInput" placeholder="name" />
            <CFormLabel htmlFor="floatingInput">Name</CFormLabel>
          </CFormFloating>
         <CFormFloating>
            <CFormInput type="email"  style={{ width: '280px' ,height:'60px'}} ref={email} id="floatingInput" placeholder="email" />
            <CFormLabel htmlFor="floatingInput">Email</CFormLabel>
          </CFormFloating>
          <CFormFloating>
            <CFormInput type="text"  style={{ width: '280px',height:'60px' }} ref={phone} id="floatingInput" placeholder="contact" />
            <CFormLabel htmlFor="floatingInput">Contact No</CFormLabel>
          </CFormFloating>
          <CFormFloating>
            <CFormInput type="textarea"  style={{ width: '280px', height:'100px' }} ref={message} id="floatingInput" placeholder="message" />
